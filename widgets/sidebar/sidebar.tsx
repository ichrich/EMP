...
export const navItems: Array<{ id: PortalView; label: string; icon: typeof LayoutDashboard }> = [
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar__brand">
        <span className="sidebar__logo-slot">{/* <span className="sidebar__logo">EMP</span> */}</span>
